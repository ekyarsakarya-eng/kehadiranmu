...
function renderLogin() {
  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center p-4 relative">
    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border-white/20">
        <div class="mb-6">
        ...
        <div class="w-full flex-shrink-0">
          <div class="bg-gradient-to-br from-[#800000] to-[#a00000] text-white rounded-2xl p-5 shadow-xl">
            ...
            <div class="grid grid-cols-2 gap-3 mb-4">
              ...
              <button onclick="quickAbsen('OUT')" class="bg-white/20 backdrop-blur-sm rounded-xl p-4 active:scale-95 transition flex-col items-center">
...
function ambilFotoAbsen() {
  ...
  absenFoto = canvas.toDataURL('image/jpeg', 0.5);
...
async function submitAbsen() {
  ...
  try {
    ...
    console.log('GPS gagal, lanjut tanpa lokasi');
  }
